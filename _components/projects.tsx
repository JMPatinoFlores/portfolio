...
export const Projects = () => {
    return (
        <section className="relative text-2xl scroll-mt-16" id="projects">
            <Image
                src="/cat-3.png"
                alt="Cat"
                width={500}
                height={500}
                className="absolute top-60 -right-40 opacity-60 hover:opacity-80 transition transform scale-x-[-1]"
            />
            <Image
                src="/planet-2.png"
                alt="Planet"
                width={150}
                height={150}
                className="absolute top-180 -right-20 opacity-60 hover:opacity-80 transition duration-500"
            />
            <Image
                src="/planet-4.png"
                alt="Planet"
                width={150}
                height={150}
                className="absolute bottom-50 -right-15 opacity-60 hover:opacity-80 transition duration-500"
            />
            ...
            <div className="-z-10 h-96 w-96 absolute bg-blue-600/20 rounded-full blur-[150px] -left-10 top-20" />
