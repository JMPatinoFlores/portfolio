...
export const Contact = () => {
    return (
        <section
            className="relative text-2xl scroll-mt-16 py-5 min-h-[70vh] flex flex-col"
            id="contact"
        >
            ...
            <Image
                ...
                width={300}
                height={300}
                className="absolute bottom-30 right-10 opacity-60 hover:opacity-80 transition transform scale-x-[-1] duration-500"
            />
            <Image
                src="/cat-2.png"
                alt="Cat"
                width={300}
                height={300}
                className="absolute -bottom-10 left-0 opacity-60 hover:opacity-80 transition transform scale-x-[-1] duration-500"
            />
